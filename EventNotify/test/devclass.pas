...
type
  ...
  public
    ...
    function Timing(Interval: DWord): integer;
...
function TEventDevice.Timing(Interval: DWord): integer;
var count: DWord;
begin
  if DeviceIOControl(FHDevice, IOCTL_TIMER_ACTIVITY, @Interval, 4, NIL, 0, count, NIL)
  then Result:=0
  else Result:=-1;
end;

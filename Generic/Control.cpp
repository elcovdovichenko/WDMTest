...
// @func Cleanup all requests on all queues
// @parm Generic.sys device extension
// @parm File object, or NULL to indicate all requests for all file objects
// @parm Status code to use in completing requests
// @comm This function cleans up IRPs for all DEVQUEUEs that were registered
// in the initial call to InitializeGenericExtension and all cached IOCTL requests.

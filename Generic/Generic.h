...
typedef struct _GENERIC_INIT_STRUCT {
	...
	PDEVQUEUE DeviceQueue;			// @field Address of queue object for read/write IRPs (optional). InitializeGenericExtension will initialize this object for you. Specify NULL if you don't queue read/write IRPs or (starting with version 1.3) if you use the Queues array instead because you have more than one queue.
